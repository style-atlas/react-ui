...
storiesOf('Button', module)
  ...
  .add('secondaryLight', () => <div style={{backgroundColor: 'grey', padding: 10}}><Button secondaryLight {...sharedProps}>Secondary Light Button</Button></div>)
  .add('secondaryLight disabled', () => <Button secondaryLight disabled {...sharedProps}>Secondary Light Button</Button>)
